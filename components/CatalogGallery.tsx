...
export default function CatalogGallery({
  ...
  return (
    <section className="bg-[#F6F3EE] py-10 px-4 sm:px-6 lg:px-8">
            ...
            {images.map((src, index) => {
              ...
              return (
                <button
                  ...
                  className="group relative aspect-square overflow-hidden rounded-lg bg-white border border-[#111111]/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E6531F]"
